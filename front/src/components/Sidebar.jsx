			...
			<div className="sidebar-navigation">
				<Nav
					...
					renderWrapper={({ itemElement, props }) => {
						...
						return (
							<Link className="sidebar-nav-router-link" to={item.to} onClick={onNavigate}>
								{itemElement}
							</Link>
						);
					}}
						...
						return (
							<React.Fragment key={section.key}>
								...
								>
									...
									{section.key === "project" ? (
										<span className="semi-nav-section-chevron" aria-hidden="true">
			...
			<div className="sidebar-footer">
				<Tooltip content={onProfile ? "点击修改个人资料与密码" : undefined}>
					<div
						...
						role={"avatar"}
						onClick={onProfile}
						style={{ cursor: onProfile ? "pointer" : undefined }}
					>
