...
export function TaskDock() {
	...
	return (
		<div className="global-floating-task-dock">
			{tasks.map((t) => (
				<div
					key={t.task_id}
					...
					style={{
						...
						maxWidth: 440,
						color: "#f8fafc",
						boxShadow: "0 20px 35px -10px rgba(0,0,0,0.4),0 0 15px rgba(59,130,246,0.25)",
						marginBottom: 8,
					}}
				>
					<div
					...
					>
						...
						<Tag size="small" color="blue" className="task-progress-tag">
							{t.progress || 0}%
						</Tag>
					</div>
					<div className="task-progress-copy">
						<IconLightningStroked size="small" /> <span>{t.progress_message || "后台异步处理中..."}</span>
					</div>
					<Progress
